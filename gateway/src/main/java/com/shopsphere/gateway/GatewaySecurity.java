  ...
  @Bean SecurityWebFilterChain security(ServerHttpSecurity http, ReactiveJwtDecoder decoder) {
    ...
    return http.csrf(ServerHttpSecurity.CsrfSpec::disable).cors(ServerHttpSecurity.CorsSpec::disable)
        .authorizeExchange(auth -> auth
            ...
            .pathMatchers(HttpMethod.GET, "/api/v1/products/wishlist", "/api/products/wishlist").authenticated()
            .pathMatchers(HttpMethod.POST, "/api/v1/products/wishlist/**", "/api/products/wishlist/**", "/api/v1/products/*/reviews", "/api/products/*/reviews").authenticated()
            .pathMatchers(HttpMethod.PUT, "/api/v1/products/*/reviews/*", "/api/products/*/reviews/*").authenticated()
            .pathMatchers(HttpMethod.DELETE, "/api/v1/products/wishlist/**", "/api/products/wishlist/**", "/api/v1/products/*/reviews/*", "/api/products/*/reviews/*").authenticated()
            .pathMatchers(HttpMethod.GET, "/api/v1/products", "/api/products", "/api/v1/products/**", "/api/products/**").permitAll()
            .pathMatchers(HttpMethod.GET, "/api/v1/inventory/**", "/api/inventory/**").permitAll()
