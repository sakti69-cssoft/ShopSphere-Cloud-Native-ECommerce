...
public final class OrderDtos{
 ...
 public record Create(@NotNull UUID userId,@NotEmpty @Size(max=100) List<@Valid Item>items,BigDecimal discount,BigDecimal deliveryFee,@Valid @NotNull AddressRequest shippingAddress){}
